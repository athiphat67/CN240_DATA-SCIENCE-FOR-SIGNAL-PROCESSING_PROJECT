...
def main():
    ...
    REASON = "[SESSION FORCE SELL] price action remains flat with insufficient volatility, triggering a forced SELL to close the position and satisfy trading activity requirements."
    # =====================================================
